      ...
      <div className="relative">
        ...
        <div className="">
          ...
          <div className="bg-white rounded p-3 md:w-1/3 w-full mx-auto my-4 flex flex-col items-center justify-center">
            <img className="w-24 block rounded" src={img} alt="" />
            <div className="p-2 flex items-center">
              <h3 className="text-primary-400 text-lg font-extrabold">{(this.state.character_selected) ? this.state.character_selected.key : ''}</h3>
              <span className="mx-2 text-primary-500">|</span>
              <h4 className="text-primary-400 text-lg font-extrabold">{this.state.money} streams</h4>
            </div>
          </div>
